<x-layout>
    ...
    <div class="relative dark:text-white">
        ...
        <div x-data="{ openImport: false, fileName: '', resetFile() {
            ...
            <div class="w-full max-w-full mt-3 p-5 bg-white dark:bg-gray-800 rounded-sm shadow-xl">
                ...
                <div x-data="{openView: false}">
                    <div class="w-full overflow-x-auto border border-gray-200 rounded-lg">
                        <table id="data-mahasiswa" class="text-sm w-full table-auto pt-1 dark:text-white">
