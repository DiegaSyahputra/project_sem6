        ...
        <div class="w-full max-w-md bg-white shadow-xl rounded-2xl p-8 space-y-6">
            ...
            <form method="POST" action="{{route('verify.email')}}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="email" id="email" required class="mt-1 w-full px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Masukkan email..." autocomplete="email">
